...
func TestCreateSnapshot(t *testing.T) {
        ...
        test := []struct {
        ...
        }{
                {
                        ...
                        existingDiskSnapshots: []*cs.Snapshot{
                                createSnapshot(snapshotName, fiveMinAgo, diskName),
                        },
                ...
                },
                {
                        ...
                        existingDiskSnapshots: []*cs.Snapshot{
                                createSnapshot(snapshotName, fiveMinAgo, diskName),
                                createSnapshot("forensic-snapshots-bad-ip-sample-disk-name2", fiveMinAgo, "sample-disk-name2"),
                        },
                        expectedSnapshots: expectedSnapshot2,
                },
                {
                        ...
                        existingDiskSnapshots: []*cs.Snapshot{
                                createSnapshot("forensic-snapshots-bad-domain-simple-disk-name", fiveMinAgo, diskName),
                        },
                        expectedSnapshots: expectedSnapshot,
                },
                {
                        ...
                        existingDiskSnapshots: []*cs.Snapshot{
                                createSnapshot(snapshotName, time.Now().Add(-time.Minute*2).Format(time.RFC3339), diskName),
                        },
...
func createSnapshot(name, time, disk string) *cs.Snapshot {
        return &cs.Snapshot{
                Name:              name,
